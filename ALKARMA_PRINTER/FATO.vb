Public Class FATO
    ...
    Sub CUST()
        ...
        Next
    End Sub
    Private Sub TXT_CUST_NAME_TextChanged(sender As Object, e As EventArgs) Handles TXT_CUST_NAME.TextChanged
        Dim DT As New DataTable
    ...
    Private Sub BTN_NEW_Click(sender As Object, e As EventArgs) Handles BTN_NEW.Click
        ...
        '=====================================================
        FILL_DGV(DG1, "SELECT * FROM FATORA_V WHERE STAT_FATO='TRUE' AND TYPE_FATO = 'غير مدفوعة' ORDER BY ID DESC")
    ...
    Private Sub BTN_SAVE_Click(sender As Object, e As EventArgs) Handles BTN_SAVE.Click
        ...
        If DT0.Rows.Count > 0 Then
            If DT0.Rows(0).Item("B1").ToString = True Then
                Dim DT As New DataTable
                Dim DA As New SqlClient.SqlDataAdapter("SELECT * FROM FATORA", SqlConn)
                DA.Fill(DT)
                ...
                DA.Update(DT)
                If MessageBox.Show("هل ترغب فى طباعة الفاتورة", "أنتبه", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        If TXT_CHOES.SelectedIndex = 0 Then
            ...
            DT.Clear()
            DA = New SqlClient.SqlDataAdapter("SELECT * FROM FATORA_V WHERE STAT_FATO ='TRUE' AND TYPE_FATO = 'غير مدفوعة' AND CODE_NUM LIKE '%" & TextBox1.Text & "%' ORDER BY ID DESC ", SqlConn)
            DA.Fill(DT)
        ...
        If TXT_CHOES.SelectedIndex = 1 Then
            ...
            Dim DA As New SqlClient.SqlDataAdapter
            DT.Clear()
            DA = New SqlClient.SqlDataAdapter("SELECT * FROM FATORA_V WHERE STAT_FATO ='TRUE' AND TYPE_FATO = 'غير مدفوعة' AND CUST_NAME LIKE '%" & TextBox1.Text & "%' ORDER BY ID DESC ", SqlConn)
            DA.Fill(DT)
            DG1.DataSource = DT.DefaultView
        End If
